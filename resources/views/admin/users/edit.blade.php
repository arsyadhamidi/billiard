    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        <form action="{{ route('data-users.update', $users->id ?? '') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="level_id"
                                                    ...
                                                    <option value="1" {{ $users->level_id == '1' ? 'selected' : '' }}>
                                                        Admin
                                                    </option>
                                                    <option value="2" {{ $users->level_id == '2' ? 'selected' : '' }}>
                                                        Pelanggan</option>
                                                </select>
                                                @error('level_id')
                                                    <div class="invalid-feedback">
