    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-3">
                        <form action="{{ route('data-pemesanan.update', $bookings->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                                                ...
                                                <select name="users_id"
                                                    ...
                                                    @foreach ($users as $data)
                                                        <option value="{{ $data->id ?? '' }}"
                                                            {{ $bookings->users_id == $data->id ? 'selected' : '' }}>
                                                            {{ $data->name ?? '-' }}</option>
                                                    @endforeach
                                                </select>
                                                @error('users_id')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="meja_id"
                                                    ...
                                                    @foreach ($mejas as $data)
                                                        <option value="{{ $data->id ?? '' }}"
                                                            {{ $bookings->meja_id == $data->id ? 'selected' : '' }}>
                                                            {{ $data->no_meja ?? '-' }}</option>
                                                    @endforeach
                                                </select>
                                                @error('meja_id')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="paket_id"
                                                    ...
                                                    @foreach ($pakets as $data)
                                                        <option value="{{ $data->id ?? '' }}"
                                                            {{ $bookings->paket_id == $data->id ? 'selected' : '' }}>
                                                            {{ $data->nama ?? '-' }}</option>
                                                    @endforeach
                                                </select>
                                                @error('paket_id')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="status"
                                                    ...
                                                    <option value="1"
                                                        {{ $bookings->status == '1' ? 'selected' : '' }}>Dipesan</option>
                                                    <option value="2"
                                                        {{ $bookings->status == '2' ? 'selected' : '' }}>Sedang Berlangsung
                                                    </option>
                                                    <option value="3"
                                                        {{ $bookings->status == '3' ? 'selected' : '' }}>Selesai</option>
                                                    <option value="4"
                                                        {{ $bookings->status == '4' ? 'selected' : '' }}>Batal</option>
                                                </select>
                                                @error('status')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="tgl_booking"
                                                    ...
                                                    value="{{ old('tgl_booking', $bookings->tgl_booking) }}">
                                                @error('tgl_booking')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="time" name="waktu_mulai"
                                                    ...
                                                    value="{{ old('waktu_mulai', $bookings->waktu_mulai ?? '') }}">
                                                @error('waktu_mulai')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="time" name="waktu_selesai"
                                                    ...
                                                    value="{{ old('waktu_selesai', $bookings->waktu_selesai ?? '') }}">
                                                @error('waktu_selesai')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
